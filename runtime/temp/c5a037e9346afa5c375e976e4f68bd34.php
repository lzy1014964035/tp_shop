<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/system\shopping.html";i:1522317281;s:66:"I:\project\demo\oscshop2\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_confirm_date" id="distribut_date">
                        <?php $__FOR_START_9425__=1;$__FOR_END_9425__=31;for($i=$__FOR_START_9425__;$i < $__FOR_END_9425__;$i+=1){ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_service_date" id="auto_service_date">
                        <?php $__FOR_START_8963__=1;$__FOR_END_8963__=31;for($i=$__FOR_START_8963__;$i < $__FOR_END_8963__;$i+=1){ ?>
