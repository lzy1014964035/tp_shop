<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./template/pc/rainbow/payment\payment.html";i:1522317287;}*/ ?>
    ...
    <style type="text/css">
        * {
        ...
        .fail-fasu {
            ...
            height: 180px;
            padding-top: 100px;
            background: url(/template/pc/rainbow/static/images/icon-pay.png) 50px 0 no-repeat;
            text-align: center
        }
        ...
        .success-fasu {
            ...
            height: 180px;
            padding-top: 100px;
            background: url(/template/pc/rainbow/static/images/icon-pay.png) -220px 0 no-repeat;
            text-align: center
        }
    ...
    <div class="wihe-ee">
        ...
        <div class="fail-success">
            ...
            <div class="fail-I-success" style="float:left">
                <!--<img src="/template/pc/rainbow/static/images/qrcode_vmall_app01.png" width="110" height="110"/>-->
                <?php echo $code_str; ?>
            </div>
