<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/pc/rainbow/user\edit_address.html";i:1522317287;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form action="" method="post" id="edit_address">
                <table width="90%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="pa-50-0">&nbsp;</td>
                        <td align="right">
                            <button type="button" class="box-ok ma-le--70" onclick="checkForm()"><span>保存收货地址</span></button>
                        </td>
                    </tr>
                </table>
