<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/pc/rainbow/cart\ajax_address.html";i:1522317287;}*/ ?>
        ...
        <?php if(is_array($address_list) || $address_list instanceof \think\Collection || $address_list instanceof \think\Paginator): $i = 0; $__LIST__ = $address_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$address): $mod = ($i % 2 );++$i;?>
            ...
            <?php if($address[is_default] == 1): ?>
                <li class="addressItem" data-address-id="<?php echo $address[address_id]; ?>">
                    <div class="item_select_t curtr fl"  data-province-id="<?php echo $address['province']; ?>" data-city-id="<?php echo $address['city']; ?>" data-district-id="<?php echo $address['district']; ?>" >
                ...
                <?php else: ?>
                <li class="addressItem" data-address-id="<?php echo $address[address_id]; ?>">
                    <div class="item_select_t fl"  data-province-id="<?php echo $address['province']; ?>" data-city-id="<?php echo $address['city']; ?>" data-district-id="<?php echo $address['district']; ?>" >
                        <span><?php echo $address[consignee]; ?>&nbsp;<?php echo $regionList[$address[province]]; ?></span>
                        <b></b>
                    </div>
                    <div class="addrdetail fl">
