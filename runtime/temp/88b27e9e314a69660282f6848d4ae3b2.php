<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"./template/mobile/rainbow/goods\search.html";i:1522317286;s:67:"I:\project\demo\oscshop2\template\mobile\rainbow\public\header.html";i:1522317286;s:68:"I:\project\demo\oscshop2\template\mobile\rainbow\public\top_nav.html";i:1522317286;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
                ...
                <form action="" method="post">
                    <div class="sear-input">
                        <a href="<?php echo U('Goods/ajaxSearch'); ?>">
                            <input type="text" id="q" value="<?php echo I('q')?>">
                        </a>
                    </div>
                </form>
            </div>
...
////                        $('.suce_ok').removeClass('two');
    ...
    function ajax_sourch_submit(){
        ...
        $.ajax({
            ...
            data:{id:'<?php echo \think\Request::instance()->param('id'); ?>',sort:'<?php echo \think\Request::instance()->param('sort'); ?>',sort_asc:'<?php echo \think\Request::instance()->param('sort_asc'); ?>',sel:'<?php echo \think\Request::instance()->param('sel'); ?>',q:$('#q').val(),is_ajax:1,p:page},
