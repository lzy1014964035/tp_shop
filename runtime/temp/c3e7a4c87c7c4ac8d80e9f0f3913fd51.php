<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/system\sms.html";i:1522317281;s:66:"I:\project\demo\oscshop2\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="row" style="display:none">
                ...
                <dd class="opt">
                    <select name="sms_platform" id="sms_platform">
                        ...
                        <option value="2"  selected="selected" <?php if($config[sms_platform] == 2): ?>selected="selected"<?php endif; ?>>短信</option>
                    </select>
