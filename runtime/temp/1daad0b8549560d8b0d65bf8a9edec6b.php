<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./template/pc/rainbow/user\reg.html";i:1522317287;s:63:"I:\project\demo\oscshop2\template\pc\rainbow\public\footer.html";i:1522317287;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">   
                        ...
                        <div class="line liney clearfix">
                            ...
                            <div class="liner">
                                <div class="clearfix checkcon">
                                    ...
                                    <span class="fn-fl">我已阅读并同意</span><a class="itxt fn-fl" href="<?php echo U('Home/Article/detail',['article_id'=>1415]); ?>" target="_blank">《<?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?>服务协议》</a>
                                    </p>
                                ...
                                <p class="v-txt" id="err_check_code">
                                    <span class="fnred">请勾选</span>我已阅读并同意<a class="itxt" href="<?php echo U('Home/Article/detail',['article_id'=>1415]); ?>" target="_blank">《<?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?>服务协议》</a>
                                </p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="fnlogin clearfix">
                        ...
                        <div class="line liney clearfix">
                            ...
                            <div class="liner">
                                ...
                                <a class="regbtn J_btn_agree" href="javascript:void(0);" onClick="check_submit();">同意协议并注册</a>
                                <p class="v-txt"><span class="fnred">请勾选</span>我已阅读并同意<a class="itxt" href="<?php echo U('Home/Article/detail',['article_id'=>1415]); ?>" target="_blank">《<?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?>服务协议》</a></p>
                        </div>
                    </div>
                    </div>
                    </div>
