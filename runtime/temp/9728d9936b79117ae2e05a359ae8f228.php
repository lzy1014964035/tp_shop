<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/rainbow/cart\index.html";i:1522317287;s:68:"I:\project\demo\oscshop2\template\pc\rainbow\public\sign-header.html";i:1522317287;s:63:"I:\project\demo\oscshop2\template\pc\rainbow\public\footer.html";i:1522317287;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		...
		<script src="/template/pc/rainbow/static/js/location.js" type="text/javascript" charset="utf-8"></script>
					...
					<div class="totalswitch">
						<div class="switchable-panel" id="guess-products">
							...
							<div class="s-panel-main">
                                ...
                                {                            
                                    $goods_likes = $sql_result_item = \think\Db::query("select * from `__PREFIX__goods` where is_recommend = 1 AND is_virtual=0 AND is_on_sale = 1 order by sort DESC limit 12"); 
...
//						alert('gg');
			...
			$(function () {
				$(document).on("click", '.moveCollect', function (e) {
					...
					$.ajax({
						type: "POST",
						url: "<?php echo U('Home/Goods/collect_goods'); ?>",//+tab,
